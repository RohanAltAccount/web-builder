...
"Make a page that showcases a photography portfolio. Include a gallery of images, an about section, and a contact form. Use a modern and clean design with a focus on the images. Use TailwindCSS for styling, React for the frontend, Next.js for the backend, and TypeScript for all code. Use functional components and hooks in React. Use framer-motion for animations and transitions. Ensure the site is responsive and works well on different screen sizes and devices.",
    },
    {
"title"
"E-commerce Website",
"Make a page that showcases an e-commerce website for selling products online. Include a product catalog, shopping cart, and checkout process. Use a modern and clean design with a focus on the products. Use TailwindCSS for styling, React for the frontend, Next.js for the backend, and TypeScript for all code. Use functional components and hooks in React. Use framer-motion for animations and transitions. Ensure the site is responsive and works well on different screen sizes and devices.",
    },
    {
"title"
"Blog Website",
